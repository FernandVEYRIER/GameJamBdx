...
namespace BDream.Noise {
	public class SourcePreviewWindow : EditorWindow {
		int _samplingWidth = 48;
		int _samplingheight = 192;
		float _samplingStep = 10f;
		float _previewScale = .4f;
		...
		[MenuItem ("BDream/Noise/New Highest Modifier")]
		static void NewHighestModifier () {
		//	BDream.Unity.UnityEditorExtension.CreateScriptableObject<Highest>();
		}
